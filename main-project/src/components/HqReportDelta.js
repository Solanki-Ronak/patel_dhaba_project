...
import SaleReportAlpha from './SalesReportDelta'; // Import sales report component
import StockReportBeta from './StockReportDelta'; // Import stock report component
...
>
  Stock Report
      ...
      <div className="report-container">
        {showSalesReport ? <SaleReportAlpha /> : <StockReportBeta />}
      </div>
    </div>
  );
};
