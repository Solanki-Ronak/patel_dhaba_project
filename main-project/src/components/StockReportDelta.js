...
const StockReportBeta = () => {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        let stockCollectionRef = collection(firestore, 'stock_beta');
        ...
        const salesCollectionRef = collection(firestore, 'sales_beta');
...
export default StockReportBeta;
